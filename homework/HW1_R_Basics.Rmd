...
#I had trouble getting the terminology of the coding down specifically the "call" feature and adding the semi-colons to run certain functions. 
#It has also taken me a bit to figure out where to put data sets that are external to the actual coding/files themselves. 
